                ...
                <div className="space-y-5">
                  ...
                  <div className="lg:hidden">
                    ...
                    <div className="relative">
                      <select className="w-full border rounded-md px-3 py-2 pl-9 text-sm sm:text-base">
                  ...
                  <div>
                    ...
                    <select className="w-full border rounded-md px-3 py-2 text-sm sm:text-base">
...
const Toggle = ({ label, value, onClick }) => (
  <div className="flex items-center justify-between">
    ...
    <button
      onClick={onClick}
      className={`w-10 h-5 sm:w-11 sm:h-6 rounded-full relative transition ${
        value ? "bg-[#00669f]" : "bg-gray-500"
      }`}
    >
      <span
        className={`absolute top-0.5 left-0.5 w-4 h-4 sm:w-5 sm:h-5 bg-white rounded-full transition ${
